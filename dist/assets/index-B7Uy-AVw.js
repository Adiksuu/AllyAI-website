...
`,l=!1)}),a&&o.length>0&&(n+=Ry(o))}}),n},Ry=t=>{let e="<table><thead><tr>";return t[0].forEach(r=>{e+=`<th>${r.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/_(.*?)_/g,"<em>$1</em>")}</th>`}),e+="</tr></thead><tbody>",t.slice(1).forEach(r=>{e+="<tr>",r.forEach(i=>{i=i.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/_(.*?)_/g,"<em>$1</em>"),e+=`<td>${i}</td>`}),e+="</tr>"}),e+="</tbody></table>",e},w6=t=>{const e=document.createElement("textarea");e.value=t,document.body.appendChild(e),e.select(),document.execCommand("copy"),e.remove()},E6=(t,e,n,r)=>{r(s=>s.filter(o=>{var a;return((a=o.parts[0])==null?void 0:a.text)!==t.text}));const i=Fe.find(s=>s.symbole===window.location.pathname.at(6)).name.toUpperCase();Lu(i,t.text,null,null,window.location.pathname.slice(6),e,n,t.file||[],null,t.key)};function C6({message:t,messagePath:e,history:n,setLoading:r,setHistory:i}){const[s,o]=E.useState(""),[a,l]=E.useState(!1),[c]=E.useState(Fe.find(u=>u.symbole===window.location.pathname.at(6)).name.toUpperCase());return E.useEffect(()=>{var u;if(((u=t==null?void 0:t.file)==null?void 0:u.length)>0){if(!t.file[0])return;const d=new Image;d.src=t.file[0],d.onload=()=>l(!0),d.onerror=()=>l(!1)}else l(!1)},[t.file]),E.useEffect(()=>{(async()=>{const d=await Km(),h=t.author==="ai"?d.length:8192;if(t.loading===!0){const m=t.text.split(" ").slice(0,h),w=2e3/m.length;let y=0;o("");const g=setInterval(()=>{const f=m.slice(0,y+1).join(" "),v=ky(f);if(o(v),y++,y>=m.length){clearInterval(g);const C=Fe.find(N=>N.symbole===window.location.pathname.at(6)).name.toUpperCase(),k=`chats/${Q.currentUser.uid}/${C}/${e}/${t.key}`;ce.ref(k).update({loading:!1})}},w);return()=>clearInterval(g)}else{const m=ky(t.text.slice(0,h));o(m)}})()},[t,e]),p.jsxs("div",{className:`message${(t==null?void 0:t.author)==="user"?" author":""}${(t==null?void 0:t.invalid)===!0?" invalid":""}`,children:[p.jsxs("div",{className:"leftside",children:[p.jsx("img",{src:Ya,alt:"logo of user"}),p.jsxs("div",{className:"list",children:[c!=="ALLY-IMAGINE"?p.jsx("button",{onClick:()=>E6(t,n,r,i),children:p.jsx(Ce,{icon:y2})}):null,p.jsx("button",{onClick:()=>w6(t.text),children:p.jsx(Ce,{icon:k2})})]})]}),p.jsxs("div",{className:"rightside",children:[a?p.jsxs("div",{className:"images",children:[t.file.slice(0,4).map(u=>p.jsx("img",{src:u,alt:"Message file"})),t.file.length>4?p.jsxs("div",{className:"count",children:["+",t.file.length-4]}):null]}):null,p.jsxs("div",{className:"info",children:[p.jsx("h2",{children:t.username}),p.jsx("span",{children:t.date})]}),t.text.startsWith("data:image")?p.jsx("img",{src:t.text,alt:"Embedded image"}):p.jsx("p",{style:{whiteSpace:"pre-line"},dangerouslySetInnerHTML:{__html:s}})]})]})}function I6(t,e,n){const r=Fe.find(s=>s.symbole===window.location.pathname.at(6)).name.toUpperCase(),i=ce.ref(`chats/${Q.currentUser.uid}/${r}/${e}/`);return new Promise((s,o)=>{i.on("value",a=>{if(!a.exists()){s("back");return}const l=[],c=[];a.forEach(u=>{const d={text:u.val().message,date:u.val().time,author:u.val().author,loading:u.val().loading||!1,username:u.val().username,file:u.val().file||null,invalid:u.val().invalid,key:u.key};if(!uo(u.val().message)&&u.val().message!==Nf){const h={role:u.val().author==="user"?"user":"model",parts:[{text:u.val().message}]};c.push(h)}l.push(d)}),t(l),n(c),s("success")})})}const S6=t=>{ce.ref(`users/${Q.currentUser.uid}/`).update({opinion:t})};function T6(){const t=[{text:"I love it!",emoji:m2},{text:"Pretty good",emoji:N2},{text:"It's okay",emoji:S2},{text:"Could be better",emoji:E2},{text:"Not great",emoji:b2},{text:"Needs work",emoji:P2}],[e,n]=E.useState("");function r({opinion:i}){return p.jsxs("button",{onClick:()=>{S6(i.text),n(i.text)},children:[p.jsx(Ce,{icon:i.emoji})," ",i.text]})}return e===""&&p.jsxs("div",{className:"message",children:[p.jsx("div",{className:"leftside",children:p.jsx("img",{src:Ya,alt:"logo of user"})}),p.jsxs("div",{className:"rightside",children:[p.jsxs("div",{className:"info",children:[p.jsx("h2",{children:"Ally"}),p.jsx("span",{children:"17:40"})]}),p.jsx("p",{children:"Help us develop, give your own opinion about us"}),p.jsx("div",{className:"feedback",children:p.jsx("div",{className:"feedback_buttons",children:t.map((i,s)=>p.jsx(r,{opinion:i},s))})})]})]})}function k6({setHistory:t,id:e,loading:n,history:r,setLoading:i}){const[s,o]=E.useState([]),a=Un(),l=E.useRef(null),[c,u]=E.useState(0),d=Fe.find(m=>m.symbole===window.location.pathname.at(6)).name.toUpperCase();E.useEffect(()=>{(async()=>{await I6(o,e,t)==="back"&&a("/")})()},[e,a,t]),E.useEffect(()=>{(async()=>{u(await ya(d.toUpperCase()))})()},[r]),E.useEffect(()=>{l.current&&l.current.scrollTo({top:l.current.scrollHeight,behavior:"smooth"})},[s]);function h(){return p.jsxs("div",{className:"message wait",children:[p.jsx("div",{className:"leftside",children:p.jsx("img",{src:Ya,alt:"logo of user"})}),p.jsxs("div",{className:"rightside",children:[p.jsx("div",{className:"line"}),p.jsx("div",{className:"line"}),p.jsx("div",{className:"line"})]})]})}return p.jsxs("div",{className:"messages",ref:l,children:[s.map((m,_)=>p.jsx(C6,{message:m,messagePath:e,history:r,setLoading:i,setHistory:t},_)),n?p.jsx(h,{}):null,!n&&c>0&&c%5===0?p.jsx(T6,{}):null]})}function R6({currentChat:t,history:e,setLoading:n,loading:r}){const[i,s]=E.useState(""),[o,a]=E.useState(0),[l,c]=E.useState([]),u=Fe.find(y=>y.symbole===window.location.pathname.at(6)).name.toUpperCase();E.useEffect(()=>{(async()=>{a(await ya(u.toUpperCase()))})()},[e]);const d=y=>{r||Lu(u.toUpperCase(),i,s,y,t,e,n,l,c)},h=y=>{y.key==="Enter"&&!y.shiftKey&&(y.preventDefault(),d(y))},m=async y=>{const g=y.target.files;c(g?Array.from(g):null)},_=y=>{const g=y.clipboardData.items;for(let f=0;f<g.length;f++)if(g[f].type.startsWith("image/")){const v=g[f].getAsFile();v&&c(C=>[...C,v]);break}},w=Fe.find(y=>y.name.toUpperCase()===u.toUpperCase()).dailyLimit;return p.jsx("div",{className:"input",onPaste:_,children:p.jsxs("form",{className:"content",onSubmit:y=>d(y),children:[p.jsx("input",{id:"upload",type:"file",multiple:!0,accept:"image/*",disabled:r,onClick:()=>l?c([]):null,onChange:m}),u==="ALLY-IMAGINE"?null:p.jsxs("label",{className:l.length>0?"uploaded":"",htmlFor:"upload",children:[l.length>0?p.jsx("span",{children:l.length}):null,p.jsx(Ce,{icon:T2})]}),p.jsx("textarea",{disabled:r||o>=w,onKeyDown:h,type:"text",placeholder:o>=w?"Prompts limit reached for today":r?"Wait for response...":"Ask question",onChange:y=>s(y.target.value),value:i}),p.jsx("button",{disabled:r,children:p.jsx(Ce,{icon:sw})})]})})}function N6(){var a;const t=Ns(),e=Un(),[n,r]=E.useState([]),[i,s]=E.useState(((a=t.state)==null?void 0:a.loading)||!1),{id:o}=Q1();return E.useEffect(()=>{e(`/chat/${o}`,{replace:!0,state:null})},[e,o]),E.useEffect(()=>{n.length===2&&s(!1)},[n]),p.jsxs("section",{className:"chat",children:[p.jsx(y6,{id:o}),p.jsx(k6,{setHistory:r,id:o,loading:i,history:n,setLoading:s}),p.jsx(R6,{currentChat:o,history:n,setLoading:s,loading:i})]})}const P6=["auto","English","Spanish","French","German","Russian","Chinese","Japanese","Korean","Arabic","Portuguese","Italian","Hindi","Bengali","Persian","Punjabi","Vietnamese","Malay","Telugu","Tamil","Marathi","Turkish","Urdu","Indonesian","German","Swedish","Norwegian","Danish","Dutch","Polish","Czech","Slovak","Hungarian","Romanian","Greek","Finnish","Hebrew","Thai","Filipino"];function b6(){const[t,e]=E.useState("Loading..."),[n,r]=E.useState("Loading..."),[i,s]=E.useState(!1),[o,a]=E.useState("auto"),[l,c]=E.useState(""),u=E.useRef(null);E.useEffect(()=>{(async()=>{const g=await Km();e(g.temperature.toString()),r(g.length.toString()),a(g.language),c(g.rules)})()},[]);function d(y){y!==o&&(a(y),s(!1))}const h=()=>{s(!i)},m=()=>{const y=u.current;y&&(y.style.height="auto",y.style.height=`${y.scrollHeight}px`)},_=y=>{c(y.target.value),m()};function w({lang:y}){return p.jsxs("div",{className:`language${y===o&&i?" primary":""}`,onClick:()=>d(y),children:[p.jsx("span",{children:y}),y===o?p.jsx("button",{onClick:()=>h(),children:p.jsx(Ce,{icon:iw})}):null]})}return p.jsxs("div",{className:"container",children:[p.jsx("h2",{children:"Output Settings"}),p.jsxs("div",{className:"list",children:[p.jsx("span",{children:"Temperature"}),p.jsx("p",{children:"temperature controls the randomness of the output. Use higher values for more creative responses, and lower values for more deterministic responses. Values can range from [0.0, 2.0]."}),p.jsx("input",{type:"text",maxLength:1,placeholder:"Values can range from [0.0, 2.0].",value:t,onChange:y=>e(y.target.value)})]}),p.jsxs("div",{className:"list",children:[p.jsx("span",{children:"Output Language"}),p.jsx("p",{children:"Select the language in which you want to receive replies"}),p.jsxs("div",{className:"select_language",children:[p.jsx(w,{lang:o},"English"),i?p.jsx("div",{className:"lang_list",children:P6.filter(y=>y!==o).map((y,g)=>p.jsx(w,{lang:y},g))}):null]})]}),p.jsxs("div",{className:"list",children:[p.jsx("span",{children:"Output Length"}),p.jsx("p",{children:"Control how long the text of the displayed response can be. Values can range from [1024, 8192]"}),p.jsx("input",{type:"text",placeholder:"Values can range from [1024, 8192].",value:n,onChange:y=>r(y.target.value)})]}),p.jsxs("div",{className:"list",children:[p.jsx("span",{children:"Custom Instructions"}),p.jsx("p",{children:"Provide your own rules that AllyAI will follow in each of your chats"}),p.jsxs("div",{className:"rules",children:[p.jsx("textarea",{ref:u,value:l,onChange:_,maxLength:300,type:"text",placeholder:"Your instructions..."}),p.jsx("span",{children:300-l.length})]}),p.jsx("button",{onClick:()=>XM(t,n,e,r,o,a,l,c),children:"SAVE SETTINGS"})]})]})}const A6=()=>{Q.signOut().then(()=>{localStorage.removeItem("user"),window.location.reload()})};function x6(){return p.jsxs("div",{className:"container",children:[p.jsx("h2",{children:"User settings"}),p.jsxs("div",{className:"list",children:[p.jsx("span",{children:"Logout"}),p.jsx("p",{children:"Log out of your account to prevent unwanted authorization."}),p.jsx("button",{onClick:()=>A6(),children:"LOGOUT"})]})]})}function O6(){return p.jsxs("section",{className:"settings",children:[p.jsx(b6,{}),p.jsx(x6,{})]})}function L6(){const t=[{path:"/",element:p.jsx(p6,{})},{path:"/settings",element:p.jsx(O6,{})},{path:"/models",element:p.jsx(v6,{})},{path:"/chat/:id",element:p.jsx(N6,{})}];return p.jsx(t2,{children:t.map((e,n)=>p.jsx(ew,{path:e.path,element:e.element},n))})}function D6({searching:t,setSearching:e,setActivate:n}){return p.jsxs("div",{className:"searchbar",children:[p.jsx("input",{onClick:()=>n(!0),type:"text",placeholder:"Search for chats...",value:t,onChange:r=>e(r.target.value)}),p.jsx("button",{"aria-label":"search",children:p.jsx(Ce,{icon:rw})})]})}function M6({setActivate:t}){const e=[{text:"Models",icon:w2,path:"/models"},{text:"Settings",icon:I2,path:"/settings"},{text:"Chats",icon:p2,path:"/chats"}];function n({button:r}){return r.text!=="Chats"?p.jsx("li",{children:p.jsxs(tw,{className:r!=null&&r.disabled?"disabled":"",to:r.path,children:[p.jsx(Ce,{icon:r.icon})," ",p.jsx("p",{children:r.text})]})}):p.jsx("li",{className:"",children:p.jsxs("a",{onClick:()=>t(!0),children:[p.jsx(Ce,{icon:r.icon})," ",p.jsx("p",{children:r.text})]})})}return p.jsx("ul",{className:"others",children:e.map((r,i)=>p.jsx(n,{button:r},i))})}function F6(){return p.jsx("div",{className:"bottom",children:p.jsxs(tw,{to:"/",className:"createChat",children:[p.jsx(Ce,{icon:R2})," Create new chat"]})})}function U6(t,e){(async()=>{const r=[];for(const i of Fe){const s=i.name,o=await ce.ref(`chats/${Q.currentUser.uid}/${s.toUpperCase()}`).once("value");o.exists()&&o.forEach(a=>{const l=a.key,c=`chats/${Q.currentUser.uid}/${s.toUpperCase()}/${l}/`;ce.ref(`${c}/message_000000`).once("value").then(u=>{const d=u.val(),h={path:l,model:s,firstMessage:d.message.trim().length>=25?`${d.message.trim().slice(0,25)}...`:`${d.message.trim()}`};r.push(h),e([...r])})})}})()}function j6({searching:t,setSearching:e,chatsList:n,setActivate:r}){const i=Un(),s=()=>{r(!1)},o=l=>{s(),i(`/chat/${l.path}`,{state:{loading:!1,model:l.model}})};function a({chat:l}){return p.jsx("div",{className:"chat",onClick:()=>o(l),children:p.jsx("p",{children:l.firstMessage})})}return p.jsxs(p.Fragment,{children:[p.jsx("div",{onClick:()=>s(),className:"blurred-bg"}),p.jsxs("div",{className:"floating_chats",children:[p.jsxs("div",{className:"top",children:[p.jsx("span",{children:p.jsx(Ce,{icon:rw})}),p.jsx("input",{type:"text",value:t,placeholder:"Search for chats...",onChange:l=>e(l.target.value)})]}),p.jsx("div",{className:"list",children:n.filter(l=>l.firstMessage.toLowerCase().includes(t.trim().toLowerCase())).map((l,c)=>p.jsx(a,{chat:l},c))})]})]})}function W6(){const[t,e]=E.useState([]),[n,r]=E.useState(""),[i,s]=E.useState(!1);return E.useEffect(()=>{e([]),U6(t,e)},[i]),p.jsxs("div",{className:"sidebar",children:[p.jsx("div",{className:"top",children:p.jsxs("div",{children:[p.jsx("img",{src:Ya,alt:"logo of app"}),p.jsx("h1",{children:"AllyAI"})]})}),p.jsx(D6,{searching:n,setSearching:r,setActivate:s}),i?p.jsx(j6,{searching:n,setSearching:r,chatsList:t,setActivate:s}):null,p.jsx(M6,{setActivate:s}),p.jsx(F6,{})]})}function MI(t,e,n,r,i,s,o,a){if(t.preventDefault(),e==="login")Q.signInWithEmailAndPassword(n,r).then(async()=>{o(!0);const l={email:n,password:r};localStorage.setItem("user",JSON.stringify(l)),await a(Q.currentUser.emailVerified)}).catch(l=>{l.code==="auth/invalid-email"?i("This email is invalid, try another one"):l.code==="auth/missing-password"?i("The invalid password"):l.code==="auth/invalid-credential"?i("The email or password is wrong, try again"):i(l.code)});else{if(s.trim().length<3){i("The username is too short");return}Q.createUserWithEmailAndPassword(n,r).then(()=>{const l={email:n,password:r,username:s,prompts:{"ALLY-2":0,"ALLY-LIE":0,"ALLY-IMAGINE":0},settings:{temperature:1,length:8192,language:"auto",rules:""}};ce.ref(`users/${Q.currentUser.uid}/`).set(l),o(!0),localStorage.setItem("user",JSON.stringify(l))}).catch(l=>{l.code==="auth/email-already-in-use"?i("This email is already in use, try another one"):l.code==="auth/invalid-email"?i("This email is invalid, try another one"):l.code==="auth/weak-password"?i("The password is too weak, it should be at least 6 characters long"):i(l.code)})}}function z6({setCurrentView:t,setAuthorized:e,setEmailVerified:n}){const[r,i]=E.useState(""),[s,o]=E.useState(""),[a,l]=E.useState("");return p.jsx("section",{className:"auth",children:p.jsxs("div",{className:"auth-container",children:[p.jsxs("div",{className:"auth-left",children:[p.jsx("h2",{children:"Sign In"}),p.jsxs("form",{onSubmit:c=>MI(c,"login",r,s,l,"",e,n),children:[p.jsxs("div",{className:"input-group",children:[p.jsx("label",{children:"EMAIL"}),p.jsx("input",{type:"text",placeholder:"Email...",value:r,onChange:c=>i(c.target.value)})]}),p.jsxs("div",{className:"input-group",children:[p.jsx("label",{children:"PASSWORD"}),p.jsx("input",{type:"password",placeholder:"Password...",value:s,onChange:c=>o(c.target.value)})]}),p.jsx("button",{type:"submit",className:"btn-signin",children:"Sign In"}),a.length>0?p.jsx("span",{children:a}):null]})]}),p.jsxs("div",{className:"auth-right",children:[p.jsx("h2",{children:"Welcome back!"}),p.jsx("p",{children:"Don't have an account?"}),p.jsx("button",{className:"btn-signup",onClick:()=>t("register"),children:"Sign Up"})]})]})})}function B6({setCurrentView:t,setAuthorized:e}){const[n,r]=E.useState(""),[i,s]=E.useState(""),[o,a]=E.useState(""),[l,c]=E.useState("");return p.jsx("section",{className:"auth",children:p.jsxs("div",{className:"auth-container",children:[p.jsxs("div",{className:"auth-left",children:[p.jsx("h2",{children:"Sign Up"}),p.jsxs("form",{onSubmit:u=>MI(u,"register",n,i,c,o,e),children:[p.jsxs("div",{className:"input-group",children:[p.jsx("label",{children:"EMAIL"}),p.jsx("input",{type:"text",placeholder:"Email...",value:n,onChange:u=>r(u.target.value)})]}),p.jsxs("div",{className:"input-group",children:[p.jsx("label",{children:"USERNAME"}),p.jsx("input",{type:"text",placeholder:"Username...",value:o,onChange:u=>a(u.target.value)})]}),p.jsxs("div",{className:"input-group",children:[p.jsx("label",{children:"PASSWORD"}),p.jsx("input",{type:"password",placeholder:"Password...",value:i,onChange:u=>s(u.target.value)})]}),p.jsx("button",{type:"submit",className:"btn-signin",children:"Sign Up"}),l.length>0?p.jsx("span",{children:l}):null]})]}),p.jsxs("div",{className:"auth-right",children:[p.jsx("h2",{children:"Create an account"}),p.jsx("p",{children:"Don't have an account?"}),p.jsx("button",{className:"btn-signup",onClick:()=>t("login"),children:"Sign In"})]})]})})}function V6(){return p.jsx("section",{className:"loading",children:p.jsx("img",{src:Ya,alt:"logo of app"})})}function $6({setAuthorized:t,setEmailVerified:e}){const[n,r]=E.useState("login"),[i]=E.useState(localStorage.getItem("user")),[s,o]=E.useState(!0);return E.useEffect(()=>{if(!i){o(!1);return}const a=JSON.parse(i);Q.signInWithEmailAndPassword(a.email,a.password).then(async()=>{t(!0),e(Q.currentUser.emailVerified),await a6(),o(!1)})},[i]),s?p.jsx(V6,{}):p.jsx(p.Fragment,{children:n==="login"?p.jsx(z6,{setCurrentView:r,setAuthorized:t,setEmailVerified:e}):p.jsx(B6,{setCurrentView:r,setAuthorized:t})})}const H6={prefix:"far",iconName:"envelope",icon:[512,512,[128386,9993,61443],"f0e0","M64 112c-8.8 0-16 7.2-16 16l0 22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1l0-22.1c0-8.8-7.2-16-16-16L64 112zM48 212.2L48 384c0 8.8 7.2 16 16 16l384 0c8.8 0 16-7.2 16-16l0-171.8L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64l384 0c35.3 0 64 28.7 64 64l0 256c0 35.3-28.7 64-64 64L64 448c-35.3 0-64-28.7-64-64L0 128z"]},G6=()=>{Q.currentUser.sendEmailVerification()};function Y6(){return p.jsxs(p.Fragment,{children:[p.jsx("div",{className:"blurred-bg"}),p.jsxs("div",{className:"verify_email",children:[p.jsx("div",{className:"top",children:p.jsx("div",{className:"icon",children:p.jsx(Ce,{icon:H6})})}),p.jsxs("div",{className:"info",children:[p.jsx("h2",{children:"Please verify your email"}),p.jsxs("p",{children:["We have sent confirmation to ",p.jsx("strong",{children:Q.currentUser.email}),". Check your email to verify"]})]}),p.jsx("div",{className:"buttons",children:p.jsx("button",{onClick:()=>G6(),children:"Send again"})})]})]})}function K6(){const[t,e]=E.useState(!1),[n,r]=E.useState(!1);return t?p.jsx(p.Fragment,{children:p.jsxs(l2,{children:[p.jsx(W6,{}),n?null:p.jsx(Y6,{}),p.jsx(L6,{})]})}):p.jsx($6,{setAuthorized:e,setEmailVerified:r})}z1(document.getElementById("root")).render(p.jsx(E.StrictMode,{children:p.jsx(K6,{})}));
